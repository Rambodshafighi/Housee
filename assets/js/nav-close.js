	...
	$(document).on('ready', function(){
		...
		$(window).on('scroll', function() {
			if ($(this).scrollTop() > 100) {
				$('.navbar-expand-lg').addClass(' menu-downv1 ');
			} else {
				$('.navbar-expand-lg').removeClass(' menu-downv1 ');
			}
		});	
		...
		$('.home-slider').owlCarousel({
			...
			nav:true,
			pullDrag:true,
			navText: ["<i class=icofont>thin_left</i>", "<i class=icofont>thin_right</i>"],
		});
		...
		// TOP BUTTON JS CODE
		$('body').append('<div id="toTop" class="top-arrow"><i class="icofont">scroll_long_up</i></div>');
		$(window).on('scroll', function () {
			if ($(this).scrollTop() != 0) {
				$('#toTop').fadeIn();
			} else {
